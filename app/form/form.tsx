...
export function ShuffleMemberForm() {
    ...
    const callApi = useCallback(async () => {
        ...
        const refs = [firstRef, secondRef, thirdRef] // ここにバグ！
    ...
    return (
        <>
            ...
            <input type="text" id="first" ref={firstRef} name="first" placeholder="1人目の名前を入力" /><br/>
            <label htmlFor="second">2人目</label>
            <input type="text" id="second" ref={secondRef} name="second" placeholder="2人目の名前を入力" /><br/>
            <label htmlFor="third">3人目</label>
            <input type="text" id="third" ref={thirdRef} name="third" placeholder="3人目の名前を入力" /><br/>
